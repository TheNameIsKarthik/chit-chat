                          ...
                          <div className='flex items-center gap-3'>
                            ...
                            <div>
                              ...
                              <div className='flex flex-wrap gap-1.5 mt-1'>
                                <span className='badge badge-secondary badge-sm'>Native: {capitalize(request.sender.nativeLanguage)}</span>
                                <span className='badge badge-outline badge-sm'>Learning: {capitalize(request.sender.learningLanguage)}</span>
                              </div>
                            </div>
                          </div>
