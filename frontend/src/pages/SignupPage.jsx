            ...
            <form onSubmit={handleSignup}>
              <div className='space-y-4 '>
                <div>
                  ...
                  <p className='text-sm opacity-70 '>Join Chit Chat and start your language learning Adventure</p>
                </div>
                ...
                <button className={`btn btn-primary w-full ${isPending ? "opacity-70" : ""}`} type='submit'>
                  {isPending ? (
                    <>
        ...
        <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
          <div className='max-w-md p-8'>
            <div className='relative aspect-square max-w-sm mx-auto'>
              <img src='/i.png' alt='logo-signup' className='w-full h-full' />
            </div>
